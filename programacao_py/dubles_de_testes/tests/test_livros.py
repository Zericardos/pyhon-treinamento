...
def test_consultar_livro_retorna_formato_resultado_string():
...
@skip
def test_consultar_chama_obter_url_usando_como_parametro_o_retorno_de_preparar_dados_para_requisicao():
    with patch("programacao_py.dubles_de_testes.colecao.livros.preparar_dados_para_requisicao") as duble_preparar:
        dados = {"autor": "Sakurai"}
        duble_preparar.return_value = dados
        with patch("programacao_py.dubles_de_testes.colecao.livros.obter_url") as duble_obter_url:
...
def test_consultar_livros_chama_executar_requisicao_usando_retorno_obter_url():
    with patch("programacao_py.dubles_de_testes.colecao.livros.obter_url") as duble_obter_url:
        ...
        with patch("programacao_py.dubles_de_testes.colecao.livros.executar_requisicao") as duble_executar_requisicao:
            consultar_livro("Sakurai")
...
def test_executar_requisicao_retorna_tipo_string_objeto_tipo_mock():
    with patch("programacao_py.dubles_de_testes.colecao.livros.urlopen") as duble_de_url_open:  # patch retorna objeto
