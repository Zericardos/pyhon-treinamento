...
graphico_valor_gorjeta_proporcional = sns.scatterplot(x='valor_da_conta',
                                                        y='porcentagem',
                                                        data=gorjetas)
graphico_valor_gorjeta_proporcional.set_title('Gráfico valor da gorjeta \
                                                 proporcional')
...
grafico_valorgorjeta_porcentagem_linha = sns.relplot(x='valor_da_conta',
                                                     ...
                                                     kind='line',
                                                     data=gorjetas)
grafico_valorgorjeta_porcentagem_linha.set_titles('Gráfico Valor Gorjeta x \
                                                    Porcentagem')
...
grafico_valorgorjetas_gorjetas_vertical = sns.catplot(x='sobremesa',
                                                      y='gorjeta',
                                                      data=gorjetas)
grafico_valorgorjetas_gorjetas_vertical.set_titles('Gráfico Valor Gorjeta x \
                                                     Gorjetas - Vertical')
...
figure_number += 1
plt.figure(figure_number, figsize)
graphico_valorgorjeta_gorjeta_distribuicao = sns.relplot(x='valor_da_conta',
                                                         y='gorjeta',
                                                         hue='sobremesa',
                                                         data=gorjetas)
graphico_valorgorjeta_gorjeta_distribuicao.set_titles('Gráfico Valor Gorjeta\
                                                        x Gorjetas -\
                                                             Distribuição')
graphico_valorgorjeta_gorjeta_distribuicao.fig.suptitle('relplot, \
                                                            hue=sobremesa')

# Two plots
figure_number += 1
plt.figure(figure_number, figsize)
grafico_valorgorjeta_gorjeta_two = sns.relplot(x='valor_da_conta', y='gorjeta',
                                               col='sobremesa',
                                               hue='sobremesa', data=gorjetas)
grafico_valorgorjeta_gorjeta_two.set_titles('Segundo Gráfico Valor Gorjeta\
                                                        x Gorjetas')
grafico_valorgorjeta_gorjeta_two.fig.suptitle('relplot, hue=sobremesa')

# Two plots, same color
figure_number += 1
plt.figure(figure_number, figsize)
grafico_valorgorjetas_gorjetas_two_same_color = sns.relplot(x='valor_da_conta',
                                                            y='gorjeta',
                                                            col='sobremesa',
                                                            data=gorjetas)
grafico_valorgorjetas_gorjetas_two_same_color.set_titles("Segundo Gráfico\
                                                            Valor Gorjeta x \
                                                                Gorjetas")
grafico_valorgorjetas_gorjetas_two_same_color.fig.suptitle('relplot, \
                                                               col=sobremesa')

# Avaliate distribution in regression model
figure_number += 1
plt.figure(figure_number, figsize)
grafico_valorgorjeta_regressao = sns.lmplot(x='valor_da_conta', y='gorjeta',
                                            col='sobremesa', hue='sobremesa',
                                            data=gorjetas)
grafico_valorgorjeta_regressao.set_titles("Gráfico Valor Gorjeta x \
                                                                Gorjetas - \
                                                                    Regressão")
grafico_valorgorjeta_regressao.fig.suptitle('lmplot, hue=sobremesa \
                                                               col=sobremesa')

# Avaliate distribution in regression model
figure_number += 1
plt.figure(figure_number, figsize)
graphico_valorgorjeta_porcentagem_regressao = sns.lmplot(x='valor_da_conta',
                                                         y='porcentagem',
                                                         col='sobremesa',
                                                         hue='sobremesa',
                                                         data=gorjetas)

graphico_valorgorjeta_porcentagem_regressao.set_titles("Gráfico Valor \
                                                         Porcentagemx Gorjetas\
                                                             - Regressão")
graphico_valorgorjeta_porcentagem_regressao.fig.suptitle('lmplot, hue=\
                                                             sobremesa col=\
                                                                 sobremesa')
print("Visualmente, existe uma diferença no valor da gorjeta daqueles que \
      pediram sobremesa e não pediram sobremesa. Entretanto, essa diferença é \
          muito sutil, vamos fazer um cálculo estatístico a respeito")

print("\n\nTeste de Hipótese")
print("\nHipótese Nula:\n A distribuição da taxa da gorjeta é a mesma nos dois\
      grupos")
print("\nHipótese Não Nula:\n A distribuição da taxa da gorjeta não é a mesma \
      nos dois grupos")
